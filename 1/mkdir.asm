...
main(int argc, char *argv[])
{
  ...
  4e:	e8 2a 03 00 00       	call   37d <mkdir>
  ...
  6d:	c7 44 24 04 a0 08 00 	movl   $0x8a0,0x4(%esp)
  74:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 456:	0f b6 80 08 0b 00 00 	movzbl 0xb08(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5b3:	75 09                	jne    5be <printf+0x101>
          s = "(null)";
 5b5:	c7 45 f4 bc 08 00 00 	movl   $0x8bc,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 67f:	a1 24 0b 00 00       	mov    0xb24,%eax
...
free(void *ap)
{
 ...
 74a:	a3 24 0b 00 00       	mov    %eax,0xb24
}
 74f:	c9                   	leave  
 750:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 79d:	e8 ce fe ff ff       	call   670 <free>
  return freep;
 7a2:	a1 24 0b 00 00       	mov    0xb24,%eax
}
 7a7:	c9                   	leave  
 7a8:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7bb:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7be:	a1 24 0b 00 00       	mov    0xb24,%eax
 7c3:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7c6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7ca:	75 23                	jne    7ef <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7cc:	c7 45 f0 1c 0b 00 00 	movl   $0xb1c,-0x10(%ebp)
 7d3:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7d6:	a3 24 0b 00 00       	mov    %eax,0xb24
 7db:	a1 24 0b 00 00       	mov    0xb24,%eax
 7e0:	a3 1c 0b 00 00       	mov    %eax,0xb1c
    base.s.size = 0;
 7e5:	c7 05 20 0b 00 00 00 	movl   $0x0,0xb20
 7ec:	00 00 00 
  }
 ...
 842:	a3 24 0b 00 00       	mov    %eax,0xb24
      return (void*)(p + 1);
 ...
 84d:	eb 38                	jmp    887 <malloc+0xde>
    ...
    if(p == freep)
 84f:	a1 24 0b 00 00       	mov    0xb24,%eax
